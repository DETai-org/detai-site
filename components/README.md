...
| --------------------- | ---------------------------------------------------------------------------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Главная (/)           | Hero, DetToDetaiBridge, DetDetaiSplit, AudienceSection, FundamentDetSection, Mission | —                    | Button (Hero), Heading (Hero), Section (Hero), Heading (DetToDetaiBridge), Section (DetToDetaiBridge), Button (DetDetaiSplit), Heading (DetDetaiSplit), Section (DetDetaiSplit), Heading (AudienceSection), Section (AudienceSection), Button (FundamentDetSection), Heading (FundamentDetSection), Section (FundamentDetSection), Heading (Mission), Section (Mission) |
| Цвета DETai (/colors) | —                                                                                  | —                    | —                                                                                                                                                                                                                                                                     |
| Contacts (/contacts)  | —                                                                                  | —                    | —                                                                                                                                                                                                                                                                     |
| Team (/team)          | —                                                                                  | —                    | —                                                                                                                                                                                                                                                                     |
| Неиспользуемые        | Projects                                                                            | —                    | Heading (Projects), Section (Projects)                                                                                                                                                                                                                                |

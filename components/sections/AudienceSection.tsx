    ...
    <Section>
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 md:mt-12 md:grid-cols-2 md:gap-8">
        {audienceCards.map((card) => (
          <div
            key={card.title}
            className="flex h-full flex-col gap-3 p-6 text-basic-dark rounded-xl border border-basic-gold-primary/30 bg-basic-gold-soft shadow-sm transition-transform duration-200 hover:-translate-y-1 hover:border-basic-gold-primary hover:shadow-lg"
          >
